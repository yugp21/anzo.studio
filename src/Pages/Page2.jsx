...
const Page2 = () => {
    ...
    return (
        <>
            <div id='section2' className='bg-white text-center p-12'>
                <h3 className='text-gray-500 mt-[-16vw] text-[1.3vw] font-[anzo3] leading-[32vw]'>©  anzo.studio 2025 | designed and developed</h3>
                <div className='rotateText mt-[-12vw]'>
                    <h1 className='text-[40vw] text-black font-[anzo4] leading-[32vw]'>IMPACTFUL</h1>
                </div>
                <div className='rotateText '>
                    <h1 className='text-[40vw] text-black font-[anzo4] leading-[32vw]'>DESIGN</h1>
                </div>
                <div className='rotateText '>
                    <h1 className='text-[40vw] text-black font-[anzo4] leading-[32vw]'>IS THE</h1>
                </div>
                <div className='rotateText '>
                    <h1 className='text-[40vw] text-black font-[anzo4] leading-[32vw]'>THAT</h1>
                </div>
                <div className='rotateText '>
                    <h1 className='text-[40vw] text-black font-[anzo4] leading-[32vw]'>WORKS!</h1>
                </div>
                ...
                <div className='h-[2px] w-1/3 relative left-1/2 -translate-x-1/2 mt-8 bg-black'></div>
            </div>
        </>
    )
}
